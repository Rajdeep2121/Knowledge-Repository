...
.box{
    ...
    <div class="container">
        <div class="box">
            <form action="addArticleToDatabase.php" method="post">
                <h2 style='text-align: center'>Add New Article <i class="fa fa-plus-circle" aria-hidden="true"></i></h2>
                <h4>Name:</h4>
                <textarea name="artname" rows="1" class="form-control"></textarea>
                
                <h4>Image Link:</h4>
                <textarea name="artimg" rows="1" class="form-control"></textarea>
